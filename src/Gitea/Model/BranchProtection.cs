...
namespace Gitea.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BranchProtection :  IEquatable<BranchProtection>
    {
        /// <summary>
        ...
        public BranchProtection(List<string> approvalsWhitelistTeams = default(List<string>), List<string> approvalsWhitelistUsername = default(List<string>), bool blockOnOutdatedBranch = default(bool), bool blockOnRejectedReviews = default(bool), string branchName = default(string), DateTime createdAt = default(DateTime), bool dismissStaleApprovals = default(bool), bool enableApprovalsWhitelist = default(bool), bool enableMergeWhitelist = default(bool), bool enablePush = default(bool), bool enablePushWhitelist = default(bool), bool enableStatusCheck = default(bool), List<string> mergeWhitelistTeams = default(List<string>), List<string> mergeWhitelistUsernames = default(List<string>), string protectedFilePatterns = default(string), bool pushWhitelistDeployKeys = default(bool), List<string> pushWhitelistTeams = default(List<string>), List<string> pushWhitelistUsernames = default(List<string>), bool requireSignedCommits = default(bool), long requiredApprovals = default(long), List<string> statusCheckContexts = default(List<string>), DateTime updatedAt = default(DateTime))
        {
        ...
        {
            return this.Equals(input as BranchProtection);
        }

        /// <summary>
        /// Returns true if BranchProtection instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchProtection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchProtection input)
        {
            if (input == null)
                return false;
