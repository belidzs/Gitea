...
namespace Gitea.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateTeamOption :  IEquatable<CreateTeamOption>
    {
        /// <summary>
        /// Defines Permission
        /// </summary>
        ...
        public CreateTeamOption(bool canCreateOrgRepo = default(bool), string description = default(string), bool includesAllRepositories = default(bool), string name = default(string), PermissionEnum? permission = default(PermissionEnum?), List<string> units = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateTeamOption and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as CreateTeamOption);
        }

        /// <summary>
        /// Returns true if CreateTeamOption instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTeamOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTeamOption input)
        {
            if (input == null)
                return false;
