...
namespace Gitea.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.1.0-alpha0";
        ...
        {
            UserAgent = "OpenAPI-Generator/0.1.0-alpha0/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/0.1.0-alpha0/csharp"
        ...
        {
            String report = "C# SDK (Gitea) Debug Report:\n";
            report += "    OS: " + System.Runtime.InteropServices.RuntimeInformation.OSDescription + "\n";
            report += "    Version of the API: 1.1.1\n";
            report += "    SDK Package Version: 0.1.0-alpha0\n";
